...
def main() -> None:
    ...
    p.add_argument("--cifar100-code-dir", default="/mnt/hd2/rpdavid/trl_export/code")
    p.add_argument("--c100-ckpt", default="/mnt/hd2/rpdavid/trl_checkpoints/checkpoints_c100_seed0/resnet18_cifar100_map.pth")
    p.add_argument("--data-root", default="./data")
    p.add_argument("--out", default="/mnt/hd2/rpdavid/results_finetune_spine/finetune_c10_spine_smoke.jsonl")
    p.add_argument("--ckpt-dir", default="/mnt/hd2/rpdavid/results_finetune_spine/checkpoints")
